...
@Component({
  selector: 'app-customer-refertravel',
  templateUrl: './customer-refertravel.page.html',
  styleUrls: ['./customer-refertravel.page.scss'],
})
export class CustomerRefertravelPage implements OnInit {
