...
export class CustomerForgetpassPage implements OnInit {
  ...
  constructor(private database: DatabaseService, 
              ...
              private commonService: CommonService
                ...
                this.customerMobileNumberForm = this.formBuilder.group({
                  customermobile: [null, Validators.compose([Validators.required, Validators.maxLength(10), Validators.minLength(10)])]
                })
  ...
  sendOTP(customerMobileNumberFormValue) {
    ...
    // let mobileNumber = customerMobileNumberFormValue.customermobile;
  ...
  confirmOTP(customerForgetPasswordFormValue) {
    if (customerForgetPasswordFormValue.otp == this.randomNumber) {
      ...
      this.database.isCustomerUSerPresent(customerForgetPasswordFormValue.customerno).subscribe((customerUserResp: Array<any>) => {
        ...
        } else if (customerUserResp[0].customer_no == customerForgetPasswordFormValue.customerno) {
