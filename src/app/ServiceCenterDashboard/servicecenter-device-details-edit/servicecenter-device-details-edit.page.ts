...
@Component({
  selector: 'app-servicecenter-device-details-edit',
  templateUrl: './servicecenter-device-details-edit.page.html',
  styleUrls: ['./servicecenter-device-details-edit.page.scss'],
})
export class ServicecenterDeviceDetailsEditPage implements OnInit {
  ...
  backToServiceCenterDeviceDetailsEdit() {
    this.router.navigate(['/servicecenter-device-details']);
  }
