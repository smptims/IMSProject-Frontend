...
@Component({
  selector: 'app-servicecenter-device-details',
  templateUrl: './servicecenter-device-details.page.html',
  styleUrls: ['./servicecenter-device-details.page.scss'],
})
export class ServicecenterDeviceDetailsPage implements OnInit {
  ...
  navToServiceCenterDeviceDtlsEdit(item: any) {
    const navigationExtras: NavigationExtras = {
      state: item
    };
    this.router.navigate(['/servicecenter-device-details-edit'], navigationExtras)
  }
