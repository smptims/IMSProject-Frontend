...
@Component({
  selector: 'app-servicecenter-daily-reports',
  templateUrl: './servicecenter-daily-reports.page.html',
  styleUrls: ['./servicecenter-daily-reports.page.scss'],
})
export class ServicecenterDailyReportsPage implements OnInit {
