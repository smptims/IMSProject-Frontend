...
export class DeviceDetailsPage implements OnInit {
  ...
  navToDeviceDtlsCreate() {
    this.router.navigate(['/device-details-create'])
  }

  navToDeviceDtlsEdit(item: any) {
    const navigationExtras: NavigationExtras = {
      state: item
    };
    this.router.navigate(['/device-details-edit'], navigationExtras)
  }
  ...
  deleteDeviceDetail(idToDelete: any) {
    ...
    }, deleteDeviceDetailError => {
      console.error('deleteDeviceDetailError:::::::::::::::::::\n', deleteDeviceDetailError)
      this.commonService.presentToast('Facing some server issue')
    });
  }
